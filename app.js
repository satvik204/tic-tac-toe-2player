...
function checkWin(boards,num,turn) {
   if (gameEnded) {
    ...
    if (boards[0] === boards[1] && boards[1] === boards[2] && boards[1] !== "") {
        ...
        square[0].style.background = "rgb(255, 174, 201)";
        square[1].style.background = "rgb(255, 174, 201)";
        square[2].style.background = "rgb(255, 174, 201)";
            ...
            square[0].style.background = "rgb(120, 200, 255)";
            square[1].style.background = "rgb(120, 200, 255)";
            square[2].style.background = "rgb(120, 200, 255)";
        ...
        if (board[3] === "O") {
            ...
            square[3].style.background = "rgb(255, 174, 201)";
            square[4].style.background = "rgb(255, 174, 201)";
            square[5].style.background = "rgb(255, 174, 201)";
                ...
                square[3].style.background = "rgb(120, 200, 255)";
                square[4].style.background = "rgb(120, 200, 255)";
                square[5].style.background = "rgb(120, 200, 255)";
    ...
    if (board[6] === "O") {
        ...
        square[6].style.background = "rgb(255, 174, 201)";
        square[7].style.background = "rgb(255, 174, 201)";
        square[8].style.background = "rgb(255, 174, 201)";
            ...
            square[6].style.background = "rgb(120, 200, 255)";
            square[7].style.background = "rgb(120, 200, 255)";
            square[8].style.background = "rgb(120, 200, 255)";
